...
const categories: Category[] = [
  {
    ...
    label: 'Fitness',
    plans: [
      { name: 'Fitness Full Day', price: 199, days: 30, sessions: 'Nelimitat' },
      { name: 'Fitness Student', price: 149, days: 30, sessions: 'Nelimitat' },
      { name: 'Fitness 3 Luni', price: 549, days: 90, sessions: 'Nelimitat', highlight: true },
      { name: 'Fitness 6 Luni', price: 999, days: 180, sessions: 'Nelimitat' },
      { name: 'Fitness 12 Luni', price: 1799, days: 365, sessions: 'Nelimitat' },
    ],
  },
  {
    id: 'clase',
    label: 'Clase',
    plans: [
      { name: 'Clase Full', price: 299, days: 30, sessions: 'Nelimitat' },
      { name: 'Clase 12 Ședințe', price: 279, days: 30, sessions: '12 sesiuni' },
      { name: 'Clase Full 3 Luni', price: 849, days: 90, sessions: 'Nelimitat', highlight: true },
      { name: 'Clase Full 6 Luni', price: 1599, days: 180, sessions: 'Nelimitat' },
      { name: 'Clase Full 12 Luni', price: 2799, days: 365, sessions: 'Nelimitat' },
    ],
  },
  {
    id: 'combo',
    label: 'Clase + Fitness',
    plans: [
      { name: 'Clase Full + Fitness', price: 329, days: 30, sessions: 'Nelimitat' },
      { name: 'Aerobic + Fitness', price: 299, days: 30, sessions: 'Nelimitat' },
      { name: 'Clase Full + Fitness 3 Luni', price: 899, days: 90, sessions: 'Nelimitat', highlight: true },
      { name: 'Clase Full + Fitness 6 Luni', price: 1699, days: 180, sessions: 'Nelimitat' },
      { name: 'Clase Full + Fitness 12 Luni', price: 2999, days: 365, sessions: 'Nelimitat' },
    ],
  },
  {
    id: 'pt',
    label: 'PT + Fitness',
    plans: [
      { name: 'PT — 1 Ședință', price: 90, days: 1, sessions: '1 sesiune' },
      { name: 'PT — 12 Ședințe', price: 800, days: 30, sessions: '12 sesiuni', highlight: true },
      { name: 'PT — 16 Ședințe', price: 1000, days: 30, sessions: '16 sesiuni' },
    ],
  },
  {
    id: 'unica',
    label: 'Ședință Unică',
    plans: [
      { name: 'Ședință unică (clasă sau fitness)', price: 40, days: 1, sessions: '1 sesiune' },
    ],
  },
];
